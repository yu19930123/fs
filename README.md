...
### 一键安装代码：
```
wget -N --no-check-certificate https://raw.githubusercontent.com/yu19930123/fs/modified/install_fs.sh && bash install_fs.sh
```
###一键卸载代码
```
wget -N --no-check-certificate https://raw.githubusercontent.com/yu19930123/fs/modified/install_fs.sh && bash install_fs.sh uninstall
```
### finalspeed操作命令
